      ...
      <div className="flex max-h-[94vh] w-full max-w-[740px] flex-col overflow-hidden rounded-xl bg-white shadow-2xl"
        ...
        <div className="flex-1 space-y-3 overflow-y-auto p-4">
          ...
          <div className="grid gap-2.5 md:grid-cols-3">
            ...
            <Field label="Satuan (Master Satuan)">
              <KNSelect data-testid="sample-unit-input" className="field" value={f.unit}
                options={masters.unitOptions} onValueChange={(v) => set("unit", v)} />
            </Field>
            <Field label="Target tanggal selesai">
              <KNDatePicker data-testid="sample-target-date"
                value={f.target_date} onChange={(v) => set("target_date", v)} />
            </Field>
          </div>
