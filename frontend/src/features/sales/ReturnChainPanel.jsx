...
import ReturnChainMap from "./ReturnChainMap";
...
export default function ReturnChainPanel({ docId }) {
  ...
  return (
    <div className="section-card" data-testid="return-chain-panel">
      ...
      <ReturnChainMap steps={steps} rolls={rolls} currentId={docId} />

      {steps.length > 0 && (
        <div className="text-[10px] font-bold uppercase tracking-wide text-[#8E8E93] mb-1 px-1">Rincian langkah</div>
      )}
