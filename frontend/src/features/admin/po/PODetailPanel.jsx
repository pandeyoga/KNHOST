  ...
  return (
    <div className={embedded ? "" : "section-card self-start"} data-testid="po-detail-panel">
      ...
      <div className="section-body space-y-3">
        ...
        {goodsReceived && <POReceiptVariancePanel variances={po.receipt_variances} />}
        {goodsReceived && (
        ...
        <div className="flex flex-col gap-1.5">
          ...
          {["receiving", "partial", "completed"].includes(po.status) && can(currentUser?.permissions, "wms", "view") && (
