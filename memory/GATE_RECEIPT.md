...
- **Waktu:** 2026-09-07 13:11:51
- **Mode:** `quick`  ·  **Durasi total:** 55s  ·  **Pekerja statik:** 1
...
| validate_compliance (file/naming/docs/api/env) | FAIL (2s) |
...
| guard:list_export SELF-TEST (bukti-merah + CSV rusak harus memerah) | PASS (1s) |
...
| guard:to_list_bound SELF-TEST (bukti-merah dua arah, 11 kasus) | FAIL (0s) |
| guard:to_list_bound (INV-PERF-01, to_list(n>20000) dilarang) | FAIL (0s) |
...
| guard:atomic_claim SELF-TEST (bukti-merah dua arah, 10 kasus) | FAIL (2s) |
| guard:atomic_claim (INV-ATOMIC-01, saga/CAS endpoint multi-koleksi) | FAIL (2s) |
...
| config_wiring SELF-TEST (bukti-merah guardrail) | PASS (12s) |
...
| guard:notif_audience SELF-TEST (bukti-merah dua arah, 14 kasus) | PASS (1s) |
