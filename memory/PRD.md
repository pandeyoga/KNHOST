...
### Berikutnya: kunci OpenAI + set emas ≥100 SJ (ocr_eval) → Fase 6 packing list (roll diharapkan) → Fase 7 beralih penuh (mode grn per entitas) · selisih SJ vs hitung di pencocokan tagihan.
