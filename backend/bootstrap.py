...
async def seed_data() -> None:
    ...
    if await db.products.count_documents({}) == 0:
        ...
        # Seed lama memakai foto stok acak (bukan barang tekstil yang dinamai).
        # Jangan menyajikannya sebagai foto produk; galeri SKU menerima foto nyata.
...
async def ensure_indexes() -> None:
    ...
    from services.product_variant_service import ensure_indexes as catalog_indexes
    await catalog_indexes()
